...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'fr': {
      ...
      'include_country_code': "Incluez l'indicatif du pays (ex. +212)",
      'send_otp': 'Envoyer le code',
      'resend': 'Renvoyer',
      'enter_otp': 'Saisir le code',
      'otp_hint': 'Saisissez le code envoyé à votre téléphone',
      'please_enter_otp': 'Veuillez saisir le code',
      'login': 'Connexion',
      'otp_sent_success': 'Code envoyé avec succès',
      'failed_send_otp': "Échec de l'envoi du code",
      ...
      'enter_a_password': 'Veuillez saisir un mot de passe',
      ...
      'verify_your_phone': 'Vérifiez votre numéro de téléphone',
      ...
      'enter_6_digit_otp': 'Veuillez saisir le code à 6 chiffres',
      'verification_failed': 'Échec de la vérification',
      'registration_failed': "Échec de l'inscription",
      'failed_resend_otp': 'Échec du renvoi du code',
    ...
    'ar': {
      ...
      'sent_code_to': 'لقد أرسلنا رمزًا مكونًا من 6 أرقام إلى',
